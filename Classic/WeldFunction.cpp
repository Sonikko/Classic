...
void __cdecl InitSonicWeldInfo_mod()
{
	...
	SonicWeldInfo[30].VertexPairCount = (uint8_t)(LengthOfArray(Sonic_RightShoeIndices) / 2);
	SonicWeldInfo[30].WeldType = 2;
	SonicWeldInfo[30].anonymous_5 = 0;
	SonicWeldInfo[30].VertexBuffer = 0;
	SonicWeldInfo[30].VertIndexes = Sonic_RightShoeIndices;
	...
	SonicWeldInfo[31].VertexPairCount = (uint8_t)(LengthOfArray(Sonic_LeftShoeIndices) / 2);
	SonicWeldInfo[31].WeldType = 2;
	SonicWeldInfo[31].anonymous_5 = 0;
	SonicWeldInfo[31].VertexBuffer = 0;
	SonicWeldInfo[31].VertIndexes = Sonic_LeftShoeIndices;
